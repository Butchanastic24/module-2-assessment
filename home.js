...
const canWeDeliver = (userZip, array) => {
    if (array.includes(userZip)){
...
const canWeDeliver2 = (userZip, array) => {
...
console.log(canWeDeliver2(85205, deliveryAreaZipCodes))
